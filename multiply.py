...
def _multiply(
    ...
    colors.astype("float32").tofile(f"data_{dataset_name}_{output_file_name_suffix}_colors.dat")
    data.astype("float32").tofile(f"data_{dataset_name}_{output_file_name_suffix}.dat")
...
if __name__ == "__main__":
    ...
    _multiply(
        ...
        num_additional_points=int(args.num_additional_points),
        radius=float(args.radius),
        output_file_name_suffix="multiplied_scaled",
        scale=10
    )
